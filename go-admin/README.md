...
[Comment the issue to tell us](https://github.com/alesjr/go-admin/go-admin/issues/71).
...
More framework examples: [https://github.com/alesjr/go-admin/go-admin/tree/master/examples](https://github.com/alesjr/go-admin/go-admin/tree/master/examples)
