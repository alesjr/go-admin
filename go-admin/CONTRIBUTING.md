...
See [manual](https://github.com/alesjr/go-admin/github.com/alesjr/go-admin/projects/3) for more information.
...
For now, you need to add your fork as a remote on the original **\$GOPATH**/src/github.com/alesjr/go-admin/go-admin clone, so:

```bash

$ go get github.com/alesjr/go-admin/go-admin
$ cd $GOPATH/src/github.com/alesjr/go-admin/go-admin # GOPATH is $HOME/go by default.
...
Notice: `go get` return `package github.com/alesjr/go-admin/go-admin: no Go files in /go/src/github.com/alesjr/go-admin/go-admin` is normal.
...
* [Tasks](https://github.com/alesjr/go-admin/github.com/alesjr/go-admin/projects)
